...
CREATE TABLE Purchase.Discount (
	id						BIGINT NOT NULL IDENTITY,
...
CREATE TRIGGER Restaurant.RestaurantTrigger ON Restaurant.Restaurant
    AFTER UPDATE
    AS
BEGIN
...
CREATE TRIGGER Purchase.DiscountTrigger ON Purchase.Discount
AFTER UPDATE
AS
BEGIN
